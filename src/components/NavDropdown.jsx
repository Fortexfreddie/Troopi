    ...
    return (  
        <div className="flex items-center gap-4">
            <div className="relative">
                ...
                <div onMouseEnter={() => setSubMenu("English")} onMouseLeave={() => setSubMenu(null)} className={`absolute z-10 shadow-lg transition-all duration-300 overflow-hidden backdrop-blur-md border border-[rgba(255,255,255,0.15)] top-8 rounded-md ${subMenu === "English" ? "opacity-100 visible" : "opacity-0 invisible"}`}>
            ...
            <div className="relative hidden lg:block">
                ...
                <div onMouseEnter={() => setSubMenu("Pi")} onMouseLeave={() => setSubMenu(null)} className={`absolute z-10 shadow-lg transition-all duration-300 overflow-hidden backdrop-blur-md border border-[rgba(255,255,255,0.15)] top-8 rounded-md ${subMenu === "Pi" ? "opacity-100 visible" : "opacity-0 invisible"}`}>
                    <ul className="text-sm">
            ...
            <div className="relative hidden lg:block">
                ...
                <div onMouseEnter={() => setSubMenu("Account")} onMouseLeave={() => setSubMenu(null)} className={`absolute z-10 shadow-lg transition-all duration-300 overflow-hidden backdrop-blur-md border border-[rgba(255,255,255,0.15)] top-8 rounded-md ${subMenu === "Account" ? "opacity-100 visible" : "opacity-0 invisible"}`}>
                    <ul className="text-sm">
